...
class SiamI2P(nn.Module):
    def __init__(self,opt:Options):
        ...
        self.img_cvd_layer=nn.Sequential(nn.Conv2d(64,64,1,bias=False),nn.BatchNorm2d(64),nn.ReLU(),nn.Conv2d(64,64,1,bias=False),nn.BatchNorm2d(64),nn.ReLU(),nn.Conv2d(64,1,1,bias=False),nn.Sigmoid())
    ...
    def forward(self,pc,intensity,sn,img,node_a,node_b):
        ...
        pc_siam_feature, img_siam_feature = self.siamese_layer(pc_feature, img_feature_flatten)
